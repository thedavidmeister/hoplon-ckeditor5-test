...
return cljs.core.cons(cljs.core.first(s),(function (){var G__15924 = (n - (1));
var G__15925 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__15924,G__15925) : clojure.test.check.rose_tree.exclude_nth.call(null,G__15924,G__15925));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__15927 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__15927) : f.call(null,G__15927));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15926_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__15926_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__15926_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15928_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__15928_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__15928_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__15929_SHARP_){
var G__15930 = clojure.test.check.rose_tree.root(p1__15929_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__15930) : pred.call(null,G__15930));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__9156__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__15931(s__15932){
return (new cljs.core.LazySeq(null,(function (){
var s__15932__$1 = s__15932;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__15932__$1);
if(temp__5457__auto__){
var xs__6012__auto__ = temp__5457__auto__;
var vec__15937 = cljs.core.first(xs__6012__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15937,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15937,(1),null);
var iterys__9152__auto__ = ((function (s__15932__$1,vec__15937,rose,index,xs__6012__auto__,temp__5457__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__15931_$_iter__15933(s__15934){
return (new cljs.core.LazySeq(null,((function (s__15932__$1,vec__15937,rose,index,xs__6012__auto__,temp__5457__auto__){
return (function (){
var s__15934__$1 = s__15934;
while(true){
var temp__5457__auto____$1 = cljs.core.seq(s__15934__$1);
if(temp__5457__auto____$1){
var s__15934__$2 = temp__5457__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__15934__$2)){
var c__9154__auto__ = cljs.core.chunk_first(s__15934__$2);
var size__9155__auto__ = cljs.core.count(c__9154__auto__);
var b__15936 = cljs.core.chunk_buffer(size__9155__auto__);
if((function (){var i__15935 = (0);
while(true){
if((i__15935 < size__9155__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__9154__auto__,i__15935);
cljs.core.chunk_append(b__15936,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__15940 = (i__15935 + (1));
i__15935 = G__15940;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15936),clojure$test$check$rose_tree$permutations_$_iter__15931_$_iter__15933(cljs.core.chunk_rest(s__15934__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15936),null);
}
} else {
var child = cljs.core.first(s__15934__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__15931_$_iter__15933(cljs.core.rest(s__15934__$2)));
}
} else {
return null;
}
...
});})(s__15932__$1,vec__15937,rose,index,xs__6012__auto__,temp__5457__auto__))
,null,null));
});})(s__15932__$1,vec__15937,rose,index,xs__6012__auto__,temp__5457__auto__))
;
var fs__9153__auto__ = cljs.core.seq(iterys__9152__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__9153__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__9153__auto__,clojure$test$check$rose_tree$permutations_$_iter__15931(cljs.core.rest(s__15932__$1)));
} else {
var G__15941 = cljs.core.rest(s__15932__$1);
s__15932__$1 = G__15941;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15942_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__15942_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__15942_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15943_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__15943_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__15943_SHARP_));
