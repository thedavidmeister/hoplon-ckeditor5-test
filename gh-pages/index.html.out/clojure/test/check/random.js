...
var G__15950 = z;
if(((24) > (function (){var G__15951 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__15951) : clojure.test.check.random.longs.bit_count.call(null,G__15951));
})())){
return clojure.test.check.random.longs.bit_xor(G__15950,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__15950;
}
});
...
var G__15954 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__15955 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__15954;
ret = G__15955;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15957__$1,cljs.core.cst$kw$state);
var vec__15959 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15959,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15959,(1),null);
