...
var G__13030 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13030,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13030;
}
});
...
var len__9553__auto___13035 = arguments.length;
var i__9554__auto___13036 = (0);
while(true){
if((i__9554__auto___13036 < len__9553__auto___13035)){
args__9560__auto__.push((arguments[i__9554__auto___13036]));

var G__13037 = (i__9554__auto___13036 + (1));
i__9554__auto___13036 = G__13037;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13032){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__13033,G__13034,seq13032__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13039,map__13039__$1,file,line,column){
return (function (p1__13038_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13038_SHARP_));
});})(map__13039,map__13039__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__9329__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__9329__auto__,prefer_table__9330__auto__,method_cache__9331__auto__,cached_hierarchy__9332__auto__,hierarchy__9333__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__8274__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__8274__auto__)){
return or__8274__auto__;
} else {
...
var temp__5457__auto___13041 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13041)){
var message_13042 = temp__5457__auto___13041;
cljs.core.println.call(null,message_13042);
} else {
}
...
var temp__5457__auto___13043 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13043)){
var message_13044 = temp__5457__auto___13043;
cljs.core.println.call(null,message_13044);
} else {
}
...
var output_dir = "/Users/davidmeister/.boot/cache/tmp/Users/davidmeister/hoplon-ckeditor5-test/1ni/-e6q9ll/main.out";
var output_dir__$1 = (function (){var G__13045 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13045),"/"].join('');
} else {
return G__13045;
}
})();
...
var G__13047 = exception.stack;
var G__13047__$1 = (((G__13047 == null))?null:clojure.string.split_lines.call(null,G__13047));
var G__13047__$2 = (((G__13047__$1 == null))?null:cljs.core.get.call(null,G__13047__$1,depth));
if((G__13047__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13047__$2);
}
} else {
...
var vec__13048 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13048,(0),null);
var column = cljs.core.nth.call(null,vec__13048,(1),null);
var vec__13051 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13051,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13051,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13051,(2),null);
...
var m__$1 = (function (){var G__13054 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__13058 = (function (){var G__13057 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13057);
} else {
return G__13057;
}
})();
...
return cljs.core.vary_meta.call(null,G__13059,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13063 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13063,(0),null);
var types = vec__13063;
...
return cljs.core.map.call(null,(function (p__13066){
var vec__13067 = p__13066;
var ns = cljs.core.nth.call(null,vec__13067,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13067,(1),null);
return ((function (vec__13067,ns,vars__$1){
return (function (){
...
var G__13070 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1){
return (function (){
var seq__13071 = cljs.core.seq.call(null,vars__$1);
var chunk__13072 = null;
var count__13073 = (0);
var i__13074 = (0);
while(true){
if((i__13074 < count__13073)){
var v = cljs.core._nth.call(null,chunk__13072,i__13074);
var temp__5457__auto___13076 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13076)){
var t_13077 = temp__5457__auto___13076;
each_fixture_fn.call(null,((function (seq__13071,chunk__13072,count__13073,i__13074,t_13077,temp__5457__auto___13076,v,each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13077)));
});})(seq__13071,chunk__13072,count__13073,i__13074,t_13077,temp__5457__auto___13076,v,each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1))
);
} else {
}

var G__13078 = seq__13071;
var G__13079 = chunk__13072;
var G__13080 = count__13073;
var G__13081 = (i__13074 + (1));
seq__13071 = G__13078;
chunk__13072 = G__13079;
count__13073 = G__13080;
i__13074 = G__13081;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13071);
if(temp__5457__auto__){
var seq__13071__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13071__$1)){
var c__9205__auto__ = cljs.core.chunk_first.call(null,seq__13071__$1);
var G__13082 = cljs.core.chunk_rest.call(null,seq__13071__$1);
var G__13083 = c__9205__auto__;
var G__13084 = cljs.core.count.call(null,c__9205__auto__);
var G__13085 = (0);
seq__13071 = G__13082;
chunk__13072 = G__13083;
count__13073 = G__13084;
i__13074 = G__13085;
continue;
} else {
var v = cljs.core.first.call(null,seq__13071__$1);
var temp__5457__auto___13086__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13086__$1)){
var t_13087 = temp__5457__auto___13086__$1;
each_fixture_fn.call(null,((function (seq__13071,chunk__13072,count__13073,i__13074,t_13087,temp__5457__auto___13086__$1,v,seq__13071__$1,temp__5457__auto__,each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13087)));
});})(seq__13071,chunk__13072,count__13073,i__13074,t_13087,temp__5457__auto___13086__$1,v,seq__13071__$1,temp__5457__auto__,each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1))
);
} else {
}

var G__13088 = cljs.core.next.call(null,seq__13071__$1);
var G__13089 = null;
var G__13090 = (0);
var G__13091 = (0);
seq__13071 = G__13088;
chunk__13072 = G__13089;
count__13073 = G__13090;
i__13074 = G__13091;
continue;
}
} else {
...
});})(each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1))
);
});})(each_fixture_fn,G__13070,G__13070__$1,env,once_fixtures,each_fixtures,vec__13067,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13070__$1)].join('')));

}
})());
});
;})(vec__13067,ns,vars__$1))
