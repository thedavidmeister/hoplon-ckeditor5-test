...
var G__13420 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__13420;
continue;
} else {
return ch;
...
var vec__13421 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__13421,(0),null);
return (match === s);
});
...
var len__9553__auto___13426 = arguments.length;
var i__9554__auto___13427 = (0);
while(true){
if((i__9554__auto___13427 < len__9553__auto___13426)){
args__9560__auto__.push((arguments[i__9554__auto___13427]));

var G__13428 = (i__9554__auto___13427 + (1));
i__9554__auto___13427 = G__13428;
continue;
} else {
}
break;
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13424){
var G__13425 = cljs.core.first.call(null,seq13424);
var seq13424__$1 = cljs.core.next.call(null,seq13424);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__13425,seq13424__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__13429__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__13429 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__13430__i = 0, G__13430__a = new Array(arguments.length -  1);
while (G__13430__i < G__13430__a.length) {G__13430__a[G__13430__i] = arguments[G__13430__i + 1]; ++G__13430__i;}
  _ = new cljs.core.IndexedSeq(G__13430__a,0,null);
} 
return G__13429__delegate.call(this,rdr,_);};
G__13429.cljs$lang$maxFixedArity = 1;
G__13429.cljs$lang$applyTo = (function (arglist__13431){
var rdr = cljs.core.first(arglist__13431);
var _ = cljs.core.rest(arglist__13431);
return G__13429__delegate(rdr,_);
});
