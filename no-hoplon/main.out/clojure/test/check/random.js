...
if(!((m__9008__auto__ == null))){
return m__9008__auto__.call(null,rng,n);
} else {
var m__9008__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__9008__auto____$1 == null))){
return m__9008__auto____$1.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__11452,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__11452;
}
});
...
var G__11455 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__11456 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__11455;
ret = G__11456;
continue;
}
...
return cljs.core._write.call(null,writer__8946__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__8274__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var state = cljs.core.get.call(null,map__11458__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__11460 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__11460,(0),null);
var r2 = cljs.core.nth.call(null,vec__11460,(1),null);
